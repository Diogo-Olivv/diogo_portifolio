...
<article class="z-10 container mx-auto max-w-4xl p-8 py-20">
	<div class="flex flex-col items-start gap-4">
		...
		<div class="flex flex-col">
			<div class="flex min-w-4xl flex-row justify-between">
				<h1 class=" text-4xl font-bold text-theme-accent2">{project.title}</h1>
		...
		<div class="prose mb-8 max-w-none whitespace-pre-line text-theme-text prose-invert">
